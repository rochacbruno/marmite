...
pub fn get_links_to(html: &str) -> Option<Vec<String>> {
    ...
    let re = Regex::new(crate::constants::LINK_HREF_PATTERN).expect("Links regex should compile");
...
pub fn get_table_of_contents_from_html(html: &str) -> String {
    let re = Regex::new(crate::constants::HEADING_PATTERN)
...
pub fn fix_internal_links(html: &str) -> String {
    let re = Regex::new(crate::constants::ANCHOR_PATTERN)
